# Evolastra documentation

Use this index to move from product operation to implementation detail.
...
- [Local Private companion](deployment/local-private.md)
- [Static hosted viewer](deployment/hosted-viewer.md)
- [Hosted team boundary](deployment/hosted-team.md)
...
- [Telemetry model](architecture/telemetry-model.md)
- [Decision log](architecture/decision-log.md)

## Integrate

- [Integration support matrix](integration/README.md)
- [Codex hooks](integration/codex-hooks.md)
- [Codex SDK](integration/codex-sdk.md)
- [Generic SDK](integration/generic-sdk.md)
- [CloudEvents protocol](event-protocol/cloud-events.md)
- [AsyncAPI specification](event-protocol/asyncapi.yaml)
